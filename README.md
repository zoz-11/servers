...
- <img height="12" width="12" src="[https://www.agentql.com/favicon/favicon.png](https://invoxx-public-bucket.s3.eu-central-1.amazonaws.com/frontend-resources/adfin-logo-small.svg)" alt="Adfin Logo" /> **[Adfin]([https://github.com/tinyfish-io/agentql-mcp](https://github.com/Adfin-Engineering/mcp-server-adfin))** - The only platform you need to get paid - faster and at a lower cost [Adfin](https://www.adfin.com/).
